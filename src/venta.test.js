...
describe("Totalizador de Ventas", () => {
  ...
  it("debería retornar 15% de descuento para montos >= 30000", () => {
  ...
  it("debería costar $3.50 para un peso de 15", () => {
    expect(calcularCostoEnvioBase(15)).toEqual(3.50);
  });
  it("debería costar $5 para un peso de 25", () => {
    expect(calcularCostoEnvioBase(25)).toEqual(5);
  });
  it("debería costar $6 para un peso de 45", () => {
    expect(calcularCostoEnvioBase(45)).toEqual(6);
  });
  it("debería costar $6.5 para un peso de 85", () => {
    expect(calcularCostoEnvioBase(85)).toEqual(6.5);
  });
